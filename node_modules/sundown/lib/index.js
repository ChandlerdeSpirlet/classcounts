...
// format an integer
var cintstr = function cintstr(num, width) {
    var str = num.toString(10);
    var len = str.length;
    var intgr = "";
    var i = void 0;
...
var frealstr = function frealstr(num, width, fract) {
...
module.exports = function sundown(d, lat, lon) {
    ...
    var julian_day = function julian_day(d) {
        ...
        if (gregorian) b = 2 - a + Math.floor(a / 4);else b = 0.0;
    ...
    var setSunriseOrSunset = function setSunriseOrSunset(key, time, az) {
        ...
        item.formatted = item.raw_time[0] + ":" + item.raw_time[1] + ", az = " + item.angle + "\xB0";
    };
